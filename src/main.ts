...
//5.Запросить  у пользователя 10 чисел и осчитать, сколько он ввел положительных, отрицательных и нулей.
//Посчитать, сколько четных и нечетных чисел. Достаточно однй переменной для вывода чисел пользователем.
